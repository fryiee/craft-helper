...
class Fields
{
    ...
    )
    {
        ...
        /** @var FieldRecord $field */
        $field = self::createField($name, $type, $handle, $settings, 'superTableBlockType:'.$superTableBlockTypeRecord->uid, $instructions, $fieldGroupId, $translationMethod, $translationKeyFormat, $runValidation);
